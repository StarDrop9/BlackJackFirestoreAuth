...
Card.prototype.getImageUrl = function(){
    ...
    return '<img src="/assets/deck/' + sundry + '-of-' + this.suit + '.png">';
};
...
function deal() {
    ...
    deck.draw('player');
    deck.draw('dealer');
    $('#dealer-hand :first-child').attr('src', '/assets/images/card.png');
    deck.draw('player');
    deck.draw('dealer');
...
function flipHoleCard() {
    ...
    var holeCardSrc = '/assets/deck/' + sundry + '-of-' + holeCard.suit + '.png';
...
function outOfChips(){
    swal({
      ...
      imageUrl: "/assets/images/chip-2.png"
    },
      function(isConfirm){
        if (isConfirm) {
          bets = new Bets();
